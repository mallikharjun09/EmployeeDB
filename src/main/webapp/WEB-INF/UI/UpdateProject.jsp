...
<body>
    ...
    <div ng-app="proUpdate" ng-controller="proUpdateCtrl">
         <form class="modal-content" action="editProject" method="post">
    
      <h1><span class="glyphicon glyphicon-pencil">EditProject</h1>
      
      <hr>
     <input type="hidden" name="projectId" value="{{x.projectId}}"/>
      ...
      <label for="email"><b>Project Head</b></label>
      <input type="text" placeholder="EnterProject Head" name="projectHead" value="{{x.projectHead}}"required>
      ...
      <div class="clearfix">
        ...
        <script>
					var app = angular.module('proUpdate', []);
					var GET = window.location.search.substring(1);
				    var params=GET.split("=");
				    var entity="findProject?projectId="+params[1];
				    
					app.controller('proUpdateCtrl', function($scope, $http) {$http.get(entity).then(
					function(response) {
